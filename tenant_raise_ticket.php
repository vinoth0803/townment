...
<div class="p-4 sm:p-6 lg:p-8 space-y-6">
  ...
  <div class="bg-white p-6 rounded shadow">
    ...
    <form id="raiseTicketForm" class="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-4">
      <input type="text" name="issue" id="issue" placeholder="Describe your issue" class="w-full md:flex-1 border p-2 rounded" required>
...
async function loadTickets() {
  try {
    ...
    document.getElementById('ticketsTable').innerHTML = `<tr><td colspan="3" class="text-center py-4 text-red-500">Error loading tickets.</td></tr>`;
  }
}
