  ...
  <div class="bg-[#F6DED8] p-6 rounded-3xl shadow-md w-full max-w-sm sm:max-w-md bg-opacity-90">
      ...
      <form id="login-form" class="space-y-4">
          ...
          <div class="relative">
              ...
              <!-- Toggle button: Positioned at the vertical center -->
              <button type="button" id="togglePassword" 
                      class="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#B82132]">
                <!-- Initially, show the eye-open icon -->
                <svg
              ...
              >
                <path
                  ...
                  d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 
                     8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z"
                />
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
